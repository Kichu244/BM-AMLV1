...
module.exports = {
    ...
    SESSION: process.env.BOTMWOL_CODE === undefined ? '' : process.env.BOTMWOL_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AUTOBİO: process.env.AUTO_BİO === undefined ? 'false' : process.env.AUTO_BİO,
    FAKE: process.env.FAKE_REMOVE === undefined ? 'false' : process.env.FAKE_REMOVE,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/ZzqO1v5.jpeg' : process.env.GAN_IMAGE,
    ...
    PHONE: process.env.NUMBER === undefined ? '+918547487332' : process.env.NUMBER,   
    OA_NAME: process.env.DEPLOYER === undefined ? 'KICHU' : process.env.DEPLOYER,
    ALL: process.env.ALL_CAPTION === undefined ? 'BotmwoL' : process.env.ALL_CAPTION,
    LG_LOGO: process.env.LG_LOGO === undefined ? 'https://telegra.ph/file/1986d89402b68b4f4aeca.jpg' : process.env.LG_LOGO,
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'Botmwol' : process.env.LOGO_NAME,
    CODE: process.env.C_CODE === undefined ? '91' : process.env.C_CODE,
    MENTION: process.env.TAG_REPLY === undefined ? '918547487332@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? '𝑩𝒐𝒕𝒎𝒘𝒐𝑳' : process.env.BOT_NAME,
    AMAL_SER: process.env.ALIVE_BUTTON === undefined ? '★/☆' : process.env.ALIVE_BUTTON,   
